...
| ---------------- | ----------------- | ------------------- | ---------------------------------- |
| `id`             | `bigint unsigned` | PK, AUTO\_INCREMENT | Identifiant unique                 |
...
| `statut`           | `enum`            | NOT NULL, DEFAULT 'en\_cours' | `en_cours` / `retourne` / `renouvele`                                       |
| `created_at`       | `timestamp`       | AUTO                          | —                                                                           |
| `updated_at`       | `timestamp`       | AUTO                          | —                                                                           |
...
| `statut`           | `enum`            | NOT NULL, DEFAULT 'en\_attente\_validation' | 🆕 Voir valeurs ci-dessous                  |
...
- `en_maintenance` → `resolue` : à la clôture de la maintenance (date\_fin renseignée)
...
- Nombre affectés (en\_service avec affectation active)
- Nombre en panne
