...
<template>
  <div class="space-y-6 animate-in fade-in duration-500">
    ...
    <div v-else class="space-y-4">
      ...
      >
        ...
        <div
          class="flex items-center justify-between sm:justify-end gap-4 border-t sm:border-t-0 pt-4 sm:pt-0"
        >
          <span
            :class="[
              'px-3 py-1 rounded-lg text-[10px] font-black uppercase',
              getEtatClass(equip.etat),
            ]"
          >
          ...
          <div class="flex items-center gap-2">
            <button
              v-if="
                equip.current_affectation &&
                equip.current_affectation.statut === 'confirmee'
              "
  ...
  >
    <div v-if="selectedEquipement" class="space-y-6">
      <div class="p-4 bg-slate-50 border border-slate-200 rounded-2xl">
        <p class="text-sm text-slate-600 font-medium">
          ...
          <span class="font-black text-slate-900"
            >{{ selectedEquipement.marque }} {{ selectedEquipement.modele }} ({{
      ...
      <div class="space-y-3">
        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            :class="[
              'p-4 rounded-2xl border-2 transition-all text-left flex flex-col gap-2',
              ['perte', 'vol', 'casse'].includes(incidentType)
      ...
      <div
        v-if="['perte', 'vol', 'casse'].includes(incidentType)"
        class="space-y-3 animate-in slide-in-from-top-2 duration-300"
      >
        <label class="text-xs font-bold text-slate-700 uppercase tracking-wider"
          >Type de sinistre</label
        >
      ...
      <div class="space-y-5">
        <div
          v-if="incidentType === 'panne'"
          class="space-y-1.5 animate-in slide-in-from-top-2 duration-300"
        >
          <label
            class="text-xs font-bold text-slate-700 uppercase tracking-wider"
            >Gravité de la panne</label
          >
          <select
        ...
        <div class="space-y-1.5">
          <label
            class="text-xs font-bold text-slate-700 uppercase tracking-wider"
            >Description & Circonstances</label
          >
          <textarea
